  ...
  <div class="admin">
    ...
    <div class="add">
      <div class="form">
        ...
        <textarea v-model="desc" cols="30" rows="10"></textarea> <br>
...
export default {
  ...
  methods: {
    ...
    selectItem(item) {
      ...
      this.newDesc = this.findItem.desc;
    },
    ...
    async editItem(item) {
      try {
        await axios.put("/api/items/id=" + item._id + "&title=" + this.newTitle + "&desc=" + this.newDesc, {});
        this.findItem = null;
        this.getData();
        return true;
      } catch (error) {
